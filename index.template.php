...
function template_body_above()
{
	...
	echo '
		<div class="topbar">
			<div class="time">
				',timeformat(time(),'%d %b %y, %H:%M %p'), '&nbsp;&raquo;&nbsp;', empty($context['user']['is_logged']) ? '<span class="greeting">' . sprintf($txt['welcome_guest'], $txt['guest_title']) . '</span>' : '<span class="greeting">' . $txt['hello_member_ndt'] . ' ' . $context['user']['name'] . '</span>', '
			</div>
...
function template_body_below()
{
	...
	<div id="footer_section">
		<ul class="reset">
			...
			<li class="copyright">', fumes_copyright(), '</li>
...
function user_area()
{
	...
	if ($context['user']['is_logged'])
	{
		if (!empty($context['user']['avatar']))
		{
			...
			echo '
				<a href="', $scripturl, '?action=profile"><img class="ava_bar" src="', $settings['images_url'], '/no_avatar.png" alt="" /></a>';
			}
		...
		<form id="guest_form" action="', $scripturl, '?action=login2" method="post" accept-charset="', $context['character_set'], '" ', empty($context['disable_login_hashing']) ? ' onsubmit="hashLoginPassword(this, \'' . $context['session_id'] . '\');"' : '', '>
			...
			<input class="input_text" type="text" size="10" name="user" value="', $txt['username'], '" onfocus="this.value = \'\';" onblur="if(this.value==\'\') this.value=\'', $txt['username'], '\';" />
			<input class="input_text" type="password" size="10" name="passwrd" value="', $txt['password'], '" onfocus="this.value = \'\';" onblur="if(this.value==\'\') this.value=\'', $txt['password'], '\';" />
			<input class="button_submit" type="submit" value="', $txt['login'], '" /><br />
...
// The Theme Copyright, please DO NOT REMOVE THIS!
function fumes_copyright()
{
	$FUMESCOPY = 'Theme by <a href="https://smftricks.com">SMF Tricks</a>';
	return $FUMESCOPY;
